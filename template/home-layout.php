...
<head>
  ...
  <script type="text/javascript" language="javascript" charset="utf-8" src="<?php echo template_url("scripts.js");?>"></script>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-dark bg-darkblue">
	  <a class="navbar-brand" href="#">Smart Exchange API</a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="<?php echo store_url("coind/services");?>">Coind Services</a>
	      </li>
